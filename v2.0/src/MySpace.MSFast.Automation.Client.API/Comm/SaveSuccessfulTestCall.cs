...
namespace MySpace.MSFast.Automation.Client.API.Comm
{
    public class SaveSuccessfulTestCall : TestingClientCall<ServerResponse>
    {
        ...
        public override void PrepareArguments()
        {
            ...
            base.IsRequestWithFile = true;

            AppendParam("r", this.TestIteration.ResultsID.ToString());
        }

        public override void WriteFile(Stream ms)
        {
            new MSFImportExportsManager().SaveProcessedDataPackage(ms, TestIteration.ProcessedDataPackage);
        }
