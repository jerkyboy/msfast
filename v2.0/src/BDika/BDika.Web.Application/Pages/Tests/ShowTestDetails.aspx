<%@ Page Language="C#" MasterPageFile="~/Masters/Main.Master" AutoEventWireup="true" CodeBehind="ShowTestDetails.aspx.cs" Inherits="BDika.Web.Application.Pages.Tests.ShowTestDetails" %>
...
<asp:Content id="cntBody" ContentPlaceHolderID="body" runat="Server">
    ...
    <asp:PlaceHolder id="phInvalidTest" runat="server">
        <asp:Literal runat="server" Text="<%$BDikaResources: Pages.Tests.ShowTestDetails, invalidtest %>" />
    </asp:PlaceHolder>
</asp:Content>
