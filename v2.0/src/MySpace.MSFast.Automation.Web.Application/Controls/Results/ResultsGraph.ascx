<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ResultsGraph.ascx.cs" Inherits="MySpace.MSFast.Automation.Web.Application.Controls.Results.ResultsGraph" %>
